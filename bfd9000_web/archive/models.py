...
class Identifier(TimestampedModel):
    ...
    use = models.CharField(max_length=16, choices=USE_CHOICES, default='official')
...
class Collection(TimestampedModel):
    ...
    start_date = models.DateField(null=True, blank=True, help_text="Collection start date")
    end_date = models.DateField(null=True, blank=True, help_text="Collection end date")
...
class Subject(TimestampedModel):
    ...
    humanname_family = models.CharField(max_length=128, help_text="Family name")
    humanname_given = models.CharField(max_length=128, help_text="Given name")
    address = models.ForeignKey(Address, on_delete=models.SET_NULL, null=True, blank=True)
...
class Encounter(TimestampedModel):
    ...
    actual_period_start = models.DateField(null=True, blank=True, help_text="Encounter start date")
    actual_period_end = models.DateField(null=True, blank=True, help_text="Encounter end date")
    ...
    def __str__(self):
        date_str = self.actual_period_start.strftime('%Y-%m-%d') if self.actual_period_start else 'No date'
...
class ImagingStudy(TimestampedModel):
    ...
    identifiers = models.ManyToManyField(Identifier, blank=True, related_name='imaging_studies')
    ...
    instance_uid = models.CharField(max_length=64, blank=True, help_text="DICOM Instance UID")
    instance_sop_class = models.CharField(max_length=64, blank=True, help_text="DICOM SOP Class")
    instance_number = models.PositiveIntegerField(null=True, blank=True)
    series_uid = models.CharField(max_length=64, blank=True, help_text="DICOM Series UID")
...
class Record(TimestampedModel):
    ...
    physical_location_compartment = models.CharField(max_length=128, blank=True)
